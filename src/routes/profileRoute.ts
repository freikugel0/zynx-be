...
router.post("/", authMiddleware, upload.single("photo"), validate(createProfileSchema), createProfile);
router.put("/", authMiddleware, upload.single("photo"), validate(updateProfileSchema), updateProfile);
